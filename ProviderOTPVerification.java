...
public class ProviderOTPVerification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verifyButton.setOnClickListener(v -> {
            ...
            if (enteredOTP.equals(String.valueOf(generatedOTP))) {
                // Add provider data to providerList
                ArrayList<ProviderModalClass> providerList;
                SharedPreferences sharedPreferences = getSharedPreferences("providerPrefs", Context.MODE_PRIVATE);
                Gson gson = new Gson();
                ...
                providerList.add(new ProviderModalClass(name, phone, email, pass,location));
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putString("providerList", gson.toJson(providerList));
                editor.apply();
                Toast.makeText(ProviderOTPVerification.this, "Provider registered successfully!", Toast.LENGTH_SHORT).show();
                sendNotification(name, "Provider Registration Request");
                Intent mainIntent = new Intent(ProviderOTPVerification.this, OTP_Status.class);
                startActivity(mainIntent);
                finish();
            } else {
                Toast.makeText(ProviderOTPVerification.this, "Incorrect OTP. Please try again.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        resend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ProviderOTPVerification.this, "New OTP sent to email", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void sendOTPEmail(final String email, final int otp) {
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected void onPostExecute(Boolean success) {
                if (success) {
                    Toast.makeText(ProviderOTPVerification.this, "OTP sent successfully!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ProviderOTPVerification.this, "Failed to send OTP. Please check your email.", Toast.LENGTH_SHORT).show();
                }
            }
        }.execute();
    }
