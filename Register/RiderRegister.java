...
public class RiderRegister extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String name1, phone1, licence1, card1, email1, pass1, location1;
                ...
                if (isValid) {
                    riderList.add(new RiderModalClass(name1,phone1,licence1,card1,pass1,location1));
                    saveData();
                    name.setText("");
                    phone.setText("");
                    licence.setText("");
    ...
    private void loadData() {
        ...
        Type type = new TypeToken<ArrayList<RiderModalClass>>() {
        }.getType();
