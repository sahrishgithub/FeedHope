...
import com.example.feedhope.RiderInterface.Register.RiderModalClass;
...
public class RiderUpdateProfile extends AppCompatActivity {
    ...
    private RiderModalClass modalClass;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (newPass.length() != 8) {
                    Toast.makeText(RiderUpdateProfile.this, "Password must be at least 8 characters long", Toast.LENGTH_SHORT).show();
                    pass.requestFocus();
                    return;
                }
                if (!isValidPhoneNumber(newPhone)) {
                    Toast.makeText(RiderUpdateProfile.this, "Please enter a valid phone number.", Toast.LENGTH_SHORT).show();
                    phone.requestFocus();
                    return;
                }
                ...
                if (result > 0) {
                    ...
                    Intent intent = new Intent(RiderUpdateProfile.this, RiderUpdateProfile.class);
