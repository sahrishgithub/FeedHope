...
public class ReceiverRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(v -> {
            String reference1, time1, member1, frequency1, phone1, email1, pass1,location1;
            ...
            location1=LocationTextView.getText().toString().trim();
            ...
            if (isValid) {
                receiverList.add(new ReceiverModalClass(reference1, selectedType, member1, selectedRequirement, frequency1, time1, phone1, email1, pass1,location1));
                saveData();
                reference.setText("");
                member.setText("");
                time.setText("");
