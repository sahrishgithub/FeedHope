...
public class ReceiverRVAdapter extends RecyclerView.Adapter<ReceiverRVAdapter.UserViewHolder> {
    ...
    public void onBindViewHolder(@NonNull UserViewHolder holder, int position) {
        ...
        holder.accept.setOnClickListener(v -> {
            boolean isInserted = db.insertData(user.getReference(),user.getType(),user.getMember(),user.getRequirement(),user.getFrequency(),user.getTime(), user.getPhone(), user.getEmail(), user.getPass(),user.getLocation());
    ...
    static class UserViewHolder extends RecyclerView.ViewHolder {
        TextView referenceText, locationText,typeText, memberText, requirementText, frequencyText, timeText, phoneText, emailText, passText;
