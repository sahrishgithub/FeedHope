...
public class OTPVerificationProvider extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verifyButton.setOnClickListener(v -> {
            ...
            if (enteredOTP.equals(String.valueOf(generatedOTP))) {
                ...
                editor.apply();
                Toast.makeText(OTPVerificationProvider.this, "Provider registered successfully!", Toast.LENGTH_SHORT).show();
                sendNotification(name, "Provider Registration Request");
                Intent mainIntent = new Intent(OTPVerificationProvider.this, OTP_Status.class);
                startActivity(mainIntent);
                finish();
            } else {
                Toast.makeText(OTPVerificationProvider.this, "Incorrect OTP. Please try again.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        resend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(OTPVerificationProvider.this, "New OTP sent to email", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void sendOTPEmail(final String email, final int otp) {
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected void onPostExecute(Boolean success) {
                if (success) {
                    Toast.makeText(OTPVerificationProvider.this, "OTP sent successfully!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(OTPVerificationProvider.this, "Failed to send OTP. Please check your email.", Toast.LENGTH_SHORT).show();
                }
            }
        }.execute();
    }
